...
- You can also use a Matlab script to import the logs in Matlab using the following script: (https://github.com/tudelft/paparazzi_log_parsing/blob/master/new_matlab/debug_flight.m)
