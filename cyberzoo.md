...
== Getting Optitrack live 3D-position data on your laptop with Netnet2ivy == #Natnet2ivy
...
= Recording images from the IP cameras = #IP-cameras
...
||Profile Name || RAW stream (or whatever you prefer) ||
||Encapsulation || MP4/MOV ||
|| Video codec || tick Video + Keep original video track ||
